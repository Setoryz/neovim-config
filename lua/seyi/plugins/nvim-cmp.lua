return {
  ...
  dependencies = {
    ...
    "hrsh7th/cmp-path", -- source for file system paths
    {
      ...
      version = "v2.*", -- Replace <CurrentMahjor> but the latest released major (first number of latest release)
    ...
    cmp.setup({
      ...
      formatting = {
        ...
        format = function(entry, vim_item)
          -- first apply the tailwindcss formatter
          vim_item = tailwind_colorizer.formatter(entry, vim_item)
          -- then apply the lspkind formatter
